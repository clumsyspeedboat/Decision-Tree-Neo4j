...
```
Citation
Davide Chicco, Giuseppe Jurman: Machine learning can predict survival of patients with 
...
```
Citation
Li, W., Ma, J., Shende, N. et al. Using machine learning of clinical data to diagnose COVID-19: 
